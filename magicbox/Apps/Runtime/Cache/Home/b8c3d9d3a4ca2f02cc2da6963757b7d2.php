                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table id="example" class="table display">
                            ...
                            <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    <td style="min-width: 80px; max-width: 80px; width: 80px; word-break: break-all; text-align:center;"><?php echo ($vo["id"]); ?></td>
                                    <td style="min-width: 100px; max-width: 100px; width: 100px; word-break: break-all; text-align:center;"><?php echo ($vo["name"]); ?></td>
                                    <td style="min-width: 100px; max-width: 100px; width: 100px; word-break: break-all; text-align:center;"><?php echo ($vo["type"]); ?></td>
                                    <td style="width: auto; word-break: break-all; text-align:center;"><?php echo ($vo["picture"]); ?></td>
                                    <td style="min-width: 100px; max-width: 100px; width: 100px; word-break: break-all; text-align:center;">$<?php echo ($vo["price"]); ?></td>
                                    <td style="min-width: 100px; max-width: 100px; width: 100px; word-break: break-all; text-align:center;"><?php echo ($vo["introduce"]); ?></td>
