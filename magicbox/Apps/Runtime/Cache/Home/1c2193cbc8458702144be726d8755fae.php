...
<div class="sidebar clearfix">
    <ul class="sidebar-panel nav">
        ...
        <li><a href="#" class="active">云柜升级日志</a></li>
    </ul>
    <ul class="sidebar-panel nav">
                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table id="example" class="table display">
                            ...
                            <?php if(is_array($versionUpdateList)): $i = 0; $__LIST__ = $versionUpdateList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <?php switch($vo["upgradetype"]): case "1": ?><td style="min-width: 100px; max-width: 100px; width: 100px; word-break: break-all; text-align:center;">升级请求</td><?php break;?>
                                        <?php case "2": ?><td style="min-width: 100px; max-width: 100px; width: 100px; word-break: break-all; text-align:center;">升级回调</td><?php break;?>
                                        <?php default: ?>
